...
To build the final jar and optimize the xunohono application for production, run:
...
Then navigate to [http://localhost:8848](http://localhost:8848) in your browser.
