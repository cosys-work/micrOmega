...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("dev.risav.uno.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("dev.risav.uno.security.DomainUserDetailsService", "createSpringSecurityUser");
