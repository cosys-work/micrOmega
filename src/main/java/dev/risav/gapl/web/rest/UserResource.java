package dev.risav.gapl.web.rest;

import dev.risav.gapl.config.Constants;
import dev.risav.gapl.domain.User;
import dev.risav.gapl.repository.UserRepository;
import dev.risav.gapl.security.AuthoritiesConstants;
import dev.risav.gapl.service.MailService;
import dev.risav.gapl.service.UserService;
import dev.risav.gapl.service.dto.AdminUserDTO;
import dev.risav.gapl.web.rest.errors.BadRequestAlertException;
import dev.risav.gapl.web.rest.errors.EmailAlreadyUsedException;
import dev.risav.gapl.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link dev.risav.gapl.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
